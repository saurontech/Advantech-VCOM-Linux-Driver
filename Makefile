...
upgrade:
	...
	make uninstall
	rm -v !(Advantech-VCOM-Linux-Driver-fun_update) -R;ls;mv ./Advantech-VCOM-Linux-Driver-fun_update/* ./;rm ./Advantech-VCOM-Linux-Driver-fun_update/ -R;make;make install;advman	-o start
